...
public class ColorUtil{
	...
	// more colors, as defined by Wikipedia at:
	// http://en.wikipedia.org/wiki/List_of_colors
	public static final Color ALICE_BLUE=new Color(240,248,255);
	public static final Color ALIZARIN=new Color(227,38,54);
	...
	public static final Color AUBURN=new Color(111,53,26);
	public static final Color AZURE_COLOR_WHEEL=new Color(0,127,255);
	public static final Color AZURE_WEB=new Color(240,255,255);
	public static final Color BABY_BLUE=new Color(111,255,255);
	public static final Color BEIGE=new Color(245,245,220);
	public static final Color BISTRE=new Color(61,43,31);
	//public static final Color BLACK=new Color(0,0,0);
	//public static final Color BLUE=new Color(0,0,255);
	public static final Color BLUE_GREEN=new Color(0,223,223);
	...
	public static final Color CHARTREUSE_YELLOW=new Color(223,255,0);
	public static final Color CHESTNUT=new Color(205,92,92);
	...
	public static final Color COSMIC_LATTE=new Color(225,248,231);
	...
	public static final Color DARK_TURQUOISE=new Color(17,96,98);
	...
	public static final Color DEEP_PINK=new Color(255,20,47);
	...
	public static final Color ELECTRIC_INDIGO=new Color(102,0,255);
	...
	public static final Color EGGPLANT=new Color(153,0,102);
	...
	public static final Color GOLD_METALLIC=new Color(212,175,55);
	public static final Color GOLD_WEB_GOLDEN=new Color(255,215,0);
	...
	public static final Color GREY_ASPARAGUS=new Color(70,89,69);
	public static final Color GREEN_COLOR_WHEEL=new Color(0,255,0);
	public static final Color GREEN_HTML=new Color(0,128,0);
	...
	public static final Color HOT_MAGENTA=new Color(255,0,204);
	public static final Color HOT_PINK=new Color(255,105,180);
	public static final Color INDIGO_DYE=new Color(0,65,106);
	public static final Color INDIGO_WEB=new Color(75,0,130);
	...
	public static final Color ISLAMIC_GREEN=new Color(0,153,0);
	...
	public static final Color KHAKI_LIGHT_KHAKI=new Color(240,230,140);
	public static final Color LAVENDER_FLORAL=new Color(181,126,220);
	public static final Color LAVENDER_WEB=new Color(230,230,250);
	...
	public static final Color LAVENDER_GREY=new Color(196,195,221);
	...
	public static final Color LAVENDER_PURPLE=new Color(150,120,182);
	...
	public static final Color LIME_COLOR_WHEEL=new Color(191,255,0);
	public static final Color LIME_WEB=new Color(0,255,0);
	...
	public static final Color MOSS_GREEN=new Color(173,223,173);
	...
	public static final Color OLD_ROSE=new Color(192,46,76);
	...
	public static final Color ORANGE_COLOR_WHEEL=new Color(255,127,0);
	public static final Color ORANGE_WEB=new Color(255,165,0);
	public static final Color ORANGE_PEEL=new Color(255,160,0);
	...
	public static final Color POWDER_BLUE_WEB=new Color(176,224,230);
	...
	public static final Color PURPLE_HTML=new Color(128,0,128);
	public static final Color PURPLE=new Color(160,92,240);
	public static final Color PURPLE_TAUPE=new Color(80,64,77);
	public static final Color RAW_UMBER=new Color(115,74,18);
	...
	public static final Color RICH_MAGENTA=new Color(202,31,23);
	...
	public static final Color ROYAL_PURPLE=new Color(107,63,160);
	public static final Color RUSSET=new Color(128,70,27);
	public static final Color RUST=new Color(183,65,14);
	public static final Color SAFETY_ORANGE_BLAZE_ORANGE=new Color(255,102,0);
	...
	public static final Color SMALT_DARK_POWDER_BLUE=new Color(0,51,153);
	public static final Color SPRING_BUD=new Color(0,167,252);
	...
	public static final Color TEA_ROSE_ORANGE=new Color(248,131,194);
	public static final Color TEA_ROSE_ROSE=new Color(244,194,194);
	public static final Color TEAL=new Color(0,128,128);
	public static final Color TAWNY=new Color(205,87,0);
	...
	public static final Color VIOLET=new Color(139,0,255);
	public static final Color VIOLET_WEB=new Color(238,130,238);
	...
	// create n colors that are as separated on a HSB color wheel as possible
	...
	public static Color getRGBNegative(Color c){
